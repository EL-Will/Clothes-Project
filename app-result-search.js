...
// let strKeyword = localStorage.getItem('keyWord')
// const arrKeyword = strKeyword.split(' ');
// let nameSearch = [];
// for (let i = 0; i < menShoesProducts.length; i++) {
//     nameSearch.push(menShoesProducts[i].nameType);
// }
// let arrIndexKeyWord=[]
// for (let j = 0; j < arrKeyword.length; j++) {
//     for (let i = 0; i < nameSearch.length; i++) {
//         let splitWord = nameSearch[i].split(' ');
//         for(let z=0; z< splitWord.length; z++){
//             if(splitWord[i].indexOf())
//         }
//     }
// }
